...
export default function Features() {
  ...
  return (
    <section
      id="features"
      ref={sectionRef}
      className="py-4 mt-20 sm:mt-0 sm:py-24 relative overflow-hidden bg-gradient-to-b from-black to-indigo-900"
    >
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold tracking-tighter text-white">
            Safe. Flexible. 
            <br />
            <span className="text-indigo-400 hover:text-white">Built for everyone</span>
          </h2>
        </motion.div>
